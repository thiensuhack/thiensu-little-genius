...
public class BaseIconTitleDialog extends Dialog implements
	...
	private ImageView mIconTitle=null;
	
	public BaseIconTitleDialog(Context context, String title, int type, int resId) {
		super(context);
		requestWindowFeature(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.base_icon_title_dialog_layout);
		...
		mIconTitle=(ImageView)findViewById(R.id.iconTitle);
	...
	protected void setIconTitle(int resid){
		mIconTitle.setBackgroundResource(resid);
	}
