...
public class ProgressWheel extends View {
    ...
    private int contourColor = Color.TRANSPARENT;
    ...
    private void setupPaints() {
        ...
        contourPaint.setColor(getContourColor());
    ...
    private void parseAttributes(TypedArray a) {
        ...
        setContourColor(a.getColor(R.styleable.ProgressWheel_contourColor, getContourColor()));
